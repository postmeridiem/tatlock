...
def populate_tools_table(cursor: sqlite3.Cursor) -> None:
    ...
    try:
        ...
        tools_to_insert = [
            ...
            ('find_personal_variables', 'Finds personal user properties from the database.', 'hippocampus.find_personal_variables_tool', 'execute_find_personal_variables', 1, 'Use find_personal_variables only when users specifically ask about their personal information (location, preferences, etc).'),
            ...
            ('recall_memories', 'Recall past conversations by keyword.', 'hippocampus.recall_memories_tool', 'execute_recall_memories', 1, 'Use recall_memories when users ask about previous conversations or topics without specifying dates.'),
            ('recall_memories_with_time', 'Recall past conversations by keyword within a date range.', 'hippocampus.recall_memories_with_time_tool', 'execute_recall_memories_with_time', 1, 'Use recall_memories_with_time when users specify date ranges or ask about conversations from specific timeframes.'),
